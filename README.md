...
######  - 프로젝트 성과
######    완성도 70%
######    1. 전국 팝업스토어 정보를 한곳에서 탐색하고 예약할 수 있는 통합 플랫폼 구축2. 카카오맵 API, 외부 데이터 연동, DB 설계 등 실제 서비스 구현 경험 확보3. 회원가입, 로그인 및 SNS 로그인, 검색, 지도, 실시간 예약 및 결제, 게시판 등의 기능을 통해    사용자 편의성을 고려한 UI/UX 구현4. 프론트엔드와 백엔드 전반에 참여하며 서비스 개발 프로세스 경험
